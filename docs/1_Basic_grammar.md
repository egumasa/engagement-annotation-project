...
| independent (main) clause | A clause that can stand alone to make a complete sentence                                                                                             | (The two example above are independent clause and sentence themselves.)  See explanation in [clause boundary detection](./1_Clause/MAIN.md).                                                                                                                                                                                                                              |
| dependent clause          | A clause that are attached to (dependent on) an independent clause.                                                                                   | If you are free (dep. cl), just come to the party (ind. cl).    See [subordinate](./1_Clause/SUBORDINATE.md) and [embedded](./1_Clause/EMBEDDED.md) clauses.                                                                                                                                                                                                                                    |
| subordinate clause        | A dependent clause that is attached to a main clause through the use of subordinate conjunctions (e.g., because, although, if, when, as, while, etc.) |        See explanation in [clause boundary detection](./1_Clause/SUBORDINATE.md).                                                                                                                                                                                                                                                                                               |
| embedded clause           | A type of dependent clause that function as a part of another clause.                                                                                 |  See explanation in [clause boundary detection](./1_Clause/EMBEDDED.md).                                                                                                                                                                                                                                                                                                      |
